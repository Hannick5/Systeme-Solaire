...
Object::Object(std::vector<glm::vec3> vertices,std::vector<glm::vec3> normals, std::vector<glm::vec2> uvs, std::string texturePath)
...
Object::Object(const char *pathObj, std::string pathTexture)
:scale(1.0f, 1.0f, 1.0f) 
{
    ...
    loadObj(pathObj, vertices, uvs, normals);

    m_vb = new VertexBuffer(vertices);
    m_uvsb = new UVBuffer(uvs);
    m_normalsb = new VertexBuffer(normals);
    m_texture = new Texture(pathTexture);
}

Object::Object(const char *pathObj, std::string pathTexture, glm::vec3 scale_)
:scale(scale_) 
{
    std::vector<glm::vec3> vertices;
    std::vector<glm::vec2> uvs;
...
void Object::rotateAround(Object& centerObject, float currentTime, float distance) {
    position = glm::vec3(
        distance * cos(currentTime) + centerObject.position.x,
